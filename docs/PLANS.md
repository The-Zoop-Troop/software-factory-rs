# Plans
Active: `exec-plans/active/` — `docs/exec-plans/active/remote-control.md` (A2A control plane, chat/CLI/web clients, multi-rig). Completed: `exec-plans/completed/`. Debt: `exec-plans/tech-debt-tracker.md`.
